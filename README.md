...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/rolecraft"><img src="https://img.shields.io/npm/dm/rolecraft?logo=npm&label=&color=cb3837" alt="npm downloads"></a>
   ...
   <a href="https://github.com/rolecraft-sh/rolecraft/actions/workflows/e2e.yml"><img src="https://img.shields.io/github/actions/workflow/status/rolecraft-sh/rolecraft/e2e.yml?logo=githubactions&label=e2e" alt="E2E Tests"></a>
...
<p align="center">
  <b>⚡ Zero dependencies</b> · <b>📦 415.4 kB</b> · <b>🤖 27 verified agents</b> · <b>🔌 Skills + MCP</b> · <b>🔒 Security scoring</b> · <b>📝 Skill testing</b> · <b>🔧 Init templates</b> · <b>🌐 Offline-first</b>
</p>
...
**Requirements:** Node.js >= 20 · 415.4 kB · zero dependencies · 87 agents · [Getting Started →](docs/guides/getting-started.md) · [Full install guide →](docs/install.md)
...
- **Zero dependencies** — 415.4 kB, only Node.js built-ins
...
| **Publish to registry**              | ✅               | ❌              | ❌                  |
| File size                            | 415.4 kB         | ~465 KB         | ~84 KB              |
