...
<p align="center">
  <b>⚡ Zero dependencies</b> · <b>📦 434.5 kB</b> · <b>🤖 27 verified agents</b> · <b>🔌 Skills + MCP</b> · <b>🔒 Security scoring</b> · <b>📝 Skill testing</b> · <b>🔧 Init templates</b> · <b>🌐 Offline-first</b>
</p>
...
**Requirements:** Node.js >= 20 · 434.5 kB · zero dependencies · 87 agents · [Getting Started →](docs/guides/getting-started.md) · [Full install guide →](docs/install.md)
...
- **Zero dependencies** — 434.5 kB, only Node.js built-ins
...
| **Publish to registry**              | ✅               | ❌              | ❌                  |
| File size                            | 434.5 kB         | ~465 KB         | ~84 KB              |
