...
<p align="center">
  <b>⚡ Zero dependencies</b> · <b>📦 415.3 kB</b> · <b>🤖 27 verified agents</b> · <b>🔌 Skills + MCP</b> · <b>🔒 Security scoring</b> · <b>📝 Skill testing</b> · <b>🔧 Init templates</b> · <b>🌐 Offline-first</b>
</p>
...
**Requirements:** Node.js >= 20 · 415.3 kB · zero dependencies · 87 agents · [Getting Started →](docs/guides/getting-started.md) · [Full install guide →](docs/install.md)
...
- **Zero dependencies** — 415.3 kB, only Node.js built-ins
...
| **Publish to registry**              | ✅               | ❌              | ❌                  |
| File size                            | 415.3 kB         | ~465 KB         | ~84 KB              |
