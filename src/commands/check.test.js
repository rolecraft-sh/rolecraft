...
let tempDir, originalCwd, originalHome, checkModule, _lockModule
...
before(async () => {
  ...
  _lockModule = await import('../utils/lockfile.js')
})
    ...
    await writeFile(
      ...
      JSON.stringify({
        ...
        skills: {
          'test/fail': {
            slug: 'test/fail',
            source: join(tempDir, 'nonexistent-dir'),
            sourceType: 'local',
            contentSha: 'somehash',
          },
        },
    ...
    await writeFile(
      ...
      JSON.stringify({
        ...
        skills: {
          'global/skill': {
            slug: 'global/skill',
            source: join(tempDir, 'nonexistent-global'),
            contentSha: 'h1',
          },
        },
        dismissed: {},
    ...
    await writeFile(
      ...
      JSON.stringify({
        ...
        skills: {
          'project/skill': {
            slug: 'project/skill',
            source: join(tempDir, 'nonexistent-project'),
            contentSha: 'h2',
          },
        },
        dismissed: {},
